...
public interface BlogPostInputOrBuilder extends
   ...
   * @return The authorId.
   */
  de.samples.apicomparison.consumer.clients.grpc.stub.UUID getAuthorId();
  /**
   * <code>optional .UUID author_id = 5;</code>
   */
  de.samples.apicomparison.consumer.clients.grpc.stub.UUIDOrBuilder getAuthorIdOrBuilder();
